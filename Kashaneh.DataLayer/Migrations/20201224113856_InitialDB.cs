    ...
    public partial class InitialDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstateStatuses", x => x.StatusId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EstateTypes_EstateTypes_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDuration = table.Column<int>(type: "int", nullable: false),
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    EstateStatusStatusId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Estates_EstateStatuses_EstateStatusStatusId",
                        column: x => x.EstateStatusStatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estates_EstateStatusStatusId",
                table: "Estates",
                column: "EstateStatusStatusId");
